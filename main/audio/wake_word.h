...
public:
    ...
    virtual void Stop() = 0;
    // Optional deep suspension for modes that temporarily need scarce internal
    // SRAM (for example the StackChan BLE dance controller).
    virtual void ReleaseRuntimeResources() {}
    virtual bool RestoreRuntimeResources() { return true; }
