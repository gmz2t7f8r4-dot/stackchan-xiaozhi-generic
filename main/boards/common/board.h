...
public:
    ...
    // Boards with a local viewfinder may pause an AI-initiated camera tool
    // until the user confirms the frame. Other boards capture immediately.
    virtual bool WaitForCameraShutter() { return true; }
    virtual void FinishCameraCapture(bool success) { (void)success; }
